...
public class BaseController {
    ...
    protected int currentlySelected = -1;
    ...
    public void init(StackPane cont, Label productInfo, AnchorPane productPane, AnchorPane productsPane,
            TextField search, JFXButton btnSort, JFXButton... btns) {
        this.cont = cont;
    ...
    protected void showCurrentProduct() {
